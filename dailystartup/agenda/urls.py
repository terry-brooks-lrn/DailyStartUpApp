...
urlpatterns = [
    ...
    path("", cache_page(timeout=43200, key_prefix="agenda")(views.root), name="home"),
    path("support-mail", cache_page(timeout=43200, key_prefix="agenda")(views.supportmail), name="support-mail"),
